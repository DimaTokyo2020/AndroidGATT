...
import com.dk.gattserver.activities.MainActivity
...
object BleAdvertiser {
    private val TAG = AdvertiseSettings::class.java.simpleName
    ...
    fun advertiseData(): AdvertiseData {
        return AdvertiseData.Builder()
            ...
            .addServiceUuid(ParcelUuid(Constance.MY_SERVICE_UUID))
            .build()
    }
}